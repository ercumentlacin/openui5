  ...
  function (
    ...
    return BaseController.extend("sap.ui.demo.nav.controller.Home", {
      ...
      onNavToEmployees: function () {
        ...
        myTest = this.byId("table1").getModel().oData.ProductCollection[
          selectedRowIndex
        ];
        console.log(myTest);
      ...
      initSampleDataModel: function () {
        ...
        jQuery.ajax(
          sap.ui.require.toUrl("sap/ui/demo/nav/mockdata/products.json"),
          {
            dataType: "json",
      ...
      getSelectedIndices: function (evt) {
        ...
        if (aIndices.length < 1) {
          ...
          sMsg = aIndices;
          selectedRowIndex = sMsg;
          this.onNavToEmployees();
        }
